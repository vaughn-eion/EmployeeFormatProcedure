...
begin
    ...
    select newID() as ID, t.Name, format(t.PhoneNumber, '(000)-000-0000'), concat(lower(Name), '@p3adaptive.com') as EmailAddress, t.ZipCode, z.State, DATEADD(S, CONVERT(int,LEFT(t.Date, 10)), '1970-01-01') as Date from TempEmployeeJoined t 
